...
function displayItems(){
    ...
    const appetizerData= foodItem.filter((item)=>item.category=='appetizers');
    const breadData= foodItem.filter((item)=>item.category=='bread');
    const mealData= foodItem.filter((item)=>item.category=='meal');
    const drinkData= foodItem.filter((item)=>item.category=='drink');
    const dessertData= foodItem.filter((item)=>item.category=='dessert');
    const othersData= foodItem.filter((item)=>item.category=='other');
